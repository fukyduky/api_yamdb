...
**Гришин Юрий** реализовал всю часть, касающуюся управления пользователями (Auth и Users).
**Грязнова Ксения** - категории (Categories), жанры (Genres) и произведения (Titles).
**Грузинцев Евгений** - отзывы (Review) и комментарии (Comments).